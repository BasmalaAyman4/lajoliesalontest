...
export const api = createApi({
  ...
  tagTypes: ['Schedule', 'Dropdown', 'SalonData', 'SalonImage', 'SalonSpecialist', 'SalonBranch', 'SalonService', 'SalonUser', 'ServiceDiscount', 'SalonSchedule', 'SalonReel', 'SalonAppointment', 'HowToUse', 'BranchChair'],
  endpoints: () => ({}),
})